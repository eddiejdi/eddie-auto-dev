...
| Path | Descricao |
|------|-----------|
| `specialized_agents/` | Modulos de agentes (api.py, agent_manager.py) |
...
- **trading-analyst** (`/trading`): para endpoints de dados de trading e metricas.
- **security-auditor** (`/security`): para auditoria de autenticacao/autorizacao em APIs.
- **infrastructure-ops** (`/infra`): para deploy e healthcheck de servicos.
- **testing-specialist** (`/testing`): para testes de integracao de endpoints.
