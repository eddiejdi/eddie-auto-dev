...
### 1.4 Customizacao Copilot/Claude
| Path | Descricao |
|------|-----------|
...
## 3. Workflow Padrao
1. **Buscar** usando grep/find antes de leitura profunda.
2. **Ler** arquivos relevantes para compreender contexto.
3. **Mapear** relacoes entre modulos encontrados.
4. **Sintetizar** resumo com paths, funcoes-chave e dependencias.

## 4. Regras
- Priorizar busca rapida (grep/find) antes de leitura profunda.
- Nao modificar codigo — apenas explorar e reportar.
- Incluir sempre paths nos resultados.
