...
- **security-auditor** (`/security`): para auditoria de firewall, SSH, e permissoes.
- **trading-analyst** (`/trading`): quando problema de infra afeta trading.
- **api-architect** (`/api`): para deploy e healthcheck de APIs.
- **testing-specialist** (`/testing`): para testes de integracao em servicos.
