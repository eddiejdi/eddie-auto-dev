...
- **infrastructure-ops** (`/infra`): para validacao de firewall, rede e SSH.
- **api-architect** (`/api`): para auditoria de autenticacao em APIs.
- **testing-specialist** (`/testing`): para testes de seguranca.
- **trading-analyst** (`/trading`): para auditoria de credenciais de exchanges.
