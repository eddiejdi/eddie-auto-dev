...
- **api-architect** (`/api`): para testes de integracao de endpoints.
- **trading-analyst** (`/trading`): para testes de regressao em estrategias.
- **security-auditor** (`/security`): para testes de seguranca e auditoria.
- **infrastructure-ops** (`/infra`): para testes E2E que envolvem servicos.
