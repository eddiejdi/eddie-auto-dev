...
|-----------|-----|-------|--------|-----|---|
| Principal | GPU0 RTX 2060 8GB | `:11434` | `mistral:7b` | Tarefas complexas: code review, refatoração | PL 140W, CC Excl, Clock lock 1000MHz |
| Secundária | GPU1 GTX 1050 2GB | `:11435` | `gemma3:1b` | Tarefas leves: resumos, classificação, parsing | PL 70W, CC Excl, Flash Attention |
