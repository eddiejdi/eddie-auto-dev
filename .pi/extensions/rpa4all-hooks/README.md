...
|----------|----------------|
| `before_agent_start` | `inject_memory_context.py` + `sidequest_nonblocking.py` |
...
| `agent_settled` | `sidequest_nonblocking.py`, `block_incomplete_stop.py`, `restore_stopped.py` |
