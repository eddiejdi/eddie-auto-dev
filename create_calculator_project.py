...
async def create_calculator_project():
    ...
    if github_result.get("success"):
        ...
        print(f"⚠️ Erro no push para GitHub: {github_result.get('error', 'Unknown error')}")
        ...
        create_result = await github_client.execute("create_repo", {
        ...
        if create_result.get("success"):
            ...
            print(f"❌ Erro: {create_result.get('error', 'Falha ao criar repositório')}")
