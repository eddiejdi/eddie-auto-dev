...
class AutoFixer:
    ...
    async def fix_until_works(self, code: str, language: str = "python", test_code: str = None) -> AutoFixResult:
        current_code = code
        errors = []
        ...
        for iteration in range(self.max_iterations):
            ...
            if result.success:
                if test_code:
                    test_result = self.test_runner.run_with_tests(current_code, test_code)
    ...
    async def generate_and_fix(self, description: str, language: str = "python", generate_tests: bool = True) -> AutoFixResult:
