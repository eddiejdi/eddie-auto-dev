...
public class JavaAgent {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            monitorAndAlertIssues(issueManager, projectManager, userService, serviceContext);
        } catch (Exception e) {
            logger.error("Error occurred while monitoring and alerting issues", e);
        }
    }

    private static void monitorAndAlertIssues(IssueManager issueManager, ProjectManager projectManager, UserService userService, ServiceContext serviceContext) throws Exception {
        // Obtenção de todas as atividades do usuário
