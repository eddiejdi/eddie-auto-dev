...
async function main() {
  ...
  try {
    ...
    const activityIdToUpdate = '12345'; // ID da atividade que deseja atualizar
    const newStatus = 'IN_PROGRESS';
    await jiraIntegration.updateActivityStatus(activityIdToUpdate, newStatus);
  } catch (error) {
