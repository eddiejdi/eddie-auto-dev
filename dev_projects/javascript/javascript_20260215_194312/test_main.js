...
async function main() {
  ...
  try {
    ...
    await javascriptAgent.trackActivity('YOUR-PROJECT-KEY', 'Task', { summary: 'New task' });

    // Atualizar a atividade
    await javascriptAgent.updateActivity('YOUR-ISSUE-ID', { description: 'Updated task description' });

    // Obter a atividade atualizada
    const activity = await javascriptAgent.getActivity('YOUR-ISSUE-ID');
