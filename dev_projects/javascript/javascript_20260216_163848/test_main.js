...
class JavaScriptAgent {
  ...
  async monitorActivity() {
    try {
      ...
      console.assert(loginResponse !== null, 'Login should return a response');
      console.assert(typeof loginResponse === 'object', 'Login response should be an object');
      ...
      for (let i = 1; i <= 5; i++) {
        ...
        console.assert(issue !== null, 'Create issue should return an issue');
        console.assert(typeof issue === 'object', 'Create issue response should be an object');
