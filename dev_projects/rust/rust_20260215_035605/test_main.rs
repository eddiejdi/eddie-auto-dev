...
mod tests {
    ...
    fn test_add_issue() {
        let mut cli = JiraCli::new();
        let issue = JiraIssue::new("123", "Fix bug in main function", "In Progress");
        cli.add_issue(issue);

        assert_eq!(cli.client.issues.len(), 1);
    }

    #[test]
    fn test_add_issue_with_invalid_id() {
        let mut cli = JiraCli::new();
        let issue = JiraIssue::new("abc", "Fix bug in main function", "In Progress");
        cli.add_issue(issue);
    ...
    #[test]
    fn test_add_issue_with_invalid_summary() {
        let mut cli = JiraCli::new();
        let issue = JiraIssue::new("123", "Fix bug in main function", "In Progress");
        cli.add_issue(issue);
    ...
    #[test]
    fn test_add_issue_with_invalid_status() {
        let mut cli = JiraCli::new();
        let issue = JiraIssue::new("123", "Fix bug in main function", "In Progress");
        cli.add_issue(issue);
