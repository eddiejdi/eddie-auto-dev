...
mod tests {
    ...
    async fn test_create_task() {
        ...
        let task = create_task(&jira_url, &username, &password, &project_key, &summary).await.unwrap();
    ...
    async fn test_update_task() {
        ...
        let task = update_task(&jira_url, &username, &password, &issue_id, &summary).await.unwrap();
    ...
    async fn test_delete_task() {
        ...
        delete_task(&jira_url, &username, &password, &issue_id).await.unwrap();
    }
    ...
    async fn test_list_tasks() {
        ...
        let tasks = list_tasks(&jira_url, &username, &password, &project_key).await.unwrap();
        println!("Tasks in project: {:?}", tasks);
    }
}