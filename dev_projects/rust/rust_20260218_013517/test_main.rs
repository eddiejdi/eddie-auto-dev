...
async fn get_issue(client: &Client, issue_key: &str) -> Result<ApiResponse, Error> {
...
async fn monitor_issue(client: &Client, issue_key: &str) -> Result<(), Error> {
...
async fn manage_tasks(client: &Client) -> Result<(), Error> {
