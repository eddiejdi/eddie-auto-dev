...
- **Streamlit — Main Dashboard (Chat)**: `specialized_agents/streamlit_app.py` — servindo em http://192.168.15.2:8501 (local: https://heights-treasure-auto-phones.trycloudflare.com). Verificado via HTTP e screenshot salvo em `/tmp/streamlit_8501.png`.
...
- `curl https://heights-treasure-auto-phones.trycloudflare.com` and Playwright screenshot `/tmp/streamlit_8501.png`
