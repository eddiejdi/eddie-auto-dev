...
python3 /home/eddie/myClaude/telegram_bot.py &
# ou
...
python3 << 'EOF'
import chromadb
client = chromadb.PersistentClient(path="/home/eddie/myClaude/chroma_db")
...
```bash
# Criar diretório
mkdir -p /home/eddie/myClaude/chroma_db

# Dar permissões
chmod 755 /home/eddie/myClaude/chroma_db
```
...
grep -A 20 "INABILITY_PATTERNS" /home/eddie/myClaude/telegram_bot.py
```
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    rm -rf /home/eddie/myClaude/chroma_db/*
...
check "ChromaDB Dir" "test -d /home/eddie/myClaude/chroma_db"
