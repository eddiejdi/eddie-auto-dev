# Llm Tool Executor Enhanced

## Informações Básicas
- **Tipo**: specialized_agent
- **Arquivo**: `specialized_agents/llm_tool_executor_enhanced.py`
...
- Publicação de eventos no AgentCo
...
## Uso
```python
from specialized_agents.llm_tool_executor_enhanced import LlmToolExecutorEnhanced
