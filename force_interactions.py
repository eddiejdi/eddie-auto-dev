...
msgs = [
    (
        "PythonAgent",
        "RequirementsAnalyst",
        "Solicitando análise de requisitos para novo módulo de autenticação",
    ),
    (
        "RequirementsAnalyst",
        "PythonAgent",
    ...
    (
        "PythonAgent",
        "TestAgent",
        "Código implementado em auth_service.py, solicito testes",
    ),
    ...
    (
        "PythonAgent",
        "JavaScriptAgent",
        "Endpoint disponível em /api/v1/auth - docs em /docs",
    ),
