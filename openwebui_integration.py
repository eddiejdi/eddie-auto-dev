...
class IntegrationClient:
    ...
    async def model_exists(self, model_name: str) -> bool:
        ...
        return model_name in models or model_name.split(":")[0] in [
    ...
    async def generate_ollama(
        self, prompt: str, profile: str = None, model: str = None, system: str = None
    ) -> ChatResponse:
    ...
    async def check_webui_status(self) -> Dict[str, Any]:
        ...
        try:
            response = await self.client.get(
                f"{self.webui_url}/api/health", timeout=5.0
            )
            return {
    ...
    async def chat_webui(
        self, prompt: str, model: str = None, conversation_id: str = None
    ) -> ChatResponse:
        """
...
Retorne o código corrigido e uma breve explicação do que foi corrigido."""
    ...
    async def get_full_status(self) -> Dict[str, Any]:
        ...
        # Check whether API key actually works (authenticated) when provided
        auth_ok = False
