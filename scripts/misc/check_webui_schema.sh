...
sqlite3 /tmp/webui.db "SELECT * FROM user WHERE email='edenilson.teixeira@rpa4all.com';"

echo ""
echo "=== Dados de auth ==="
sqlite3 /tmp/webui.db "SELECT * FROM auth WHERE email='edenilson.teixeira@rpa4all.com';"
