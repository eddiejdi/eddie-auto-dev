#!/usr/bin/env python3
"""Create or update the Authentik proxy provider for homelab.rpa4all.com."""
...
APP_SLUG = os.environ.get("AUTHENTIK_HOMELAB_APP_SLUG", "homelab-api")
APP_NAME = os.environ.get("AUTHENTIK_HOMELAB_APP_NAME", "Homelab API")
PROVIDER_NAME = os.environ.get("AUTHENTIK_HOMELAB_PROVIDER_NAME", "Homelab API Proxy")
EXTERNAL_HOST = os.environ.get("AUTHENTIK_HOMELAB_EXTERNAL_HOST", "https://homelab.rpa4all.com")
