#!/usr/bin/env python3
"""Create or update the Authentik proxy provider for NAS OMV."""
...
APP_SLUG = os.environ.get("AUTHENTIK_NAS_APP_SLUG", "nas-omv")
APP_NAME = os.environ.get("AUTHENTIK_NAS_APP_NAME", "NAS OMV")
PROVIDER_NAME = os.environ.get("AUTHENTIK_NAS_PROVIDER_NAME", "NAS OMV Proxy")
EXTERNAL_HOST = os.environ.get("AUTHENTIK_NAS_EXTERNAL_HOST", "https://nas.rpa4all.com")
...
def ensure_application(provider_pk: str) -> dict:
