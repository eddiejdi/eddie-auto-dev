...
class AutomationEngine:
    ...
    def __init__(self, device_manager, event_handler, config: Dict[str, Any]):
    ...
    async def start(self) -> None:
        ...
        self._running = True
        logger.info(
            f"Automation Engine iniciado com {len(self._automations)} automações"
        )
    ...
    async def _load_automations(self) -> None:
        ...
        self._automations = {
            "exemplo_boa_noite": {
                ...
                "trigger": {"type": TriggerType.CRON, "cron": "0 23 * * *"},
                "conditions": [
    ...
    def _state_matches(self, expected: Dict[str, Any], actual: Dict[str, Any]) -> bool:
    ...
    async def _notify_execution(
        self, automation: Dict[str, Any], success: bool, results: List[Dict[str, Any]]
    ) -> None:
