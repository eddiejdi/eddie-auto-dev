...
async def test_database():
    ...
    try:
        ...
        config = {"database": {"type": "sqlite", "path": "test_smartlife.db"}}
...
async def test_tuya_client():
    ...
    try:
        ...
        cloud = TuyaCloudClient(
            api_key="test_key", api_secret="test_secret", region="eu"
        )
...
async def test_api():
    ...
    try:
        ...
        config = {"api": {"host": "0.0.0.0", "port": 8100}}
...
async def test_service():
    ...
    try:
        ...
        config = {
            "tuya": {"api_key": "test", "api_secret": "test", "region": "eu"},
            "local": {"enabled": False},
