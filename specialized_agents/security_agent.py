...
class SecurityAgent:
                ...
                for match in matches:
                    ...
                    vulnerabilities.append(
                        Vulnerability(
                            ...
                            recommendation="Remova o secret do código e use variáveis de ambiente ou vault de secrets",
                            cwe_id="CWE-798",
                            cvss_score=9.0,
                        )
                    )
    ...
    def scan_directory(
        self, target_path: str = None, extensions: List[str] = None
    ) -> SecurityReport:
        """
...
"""
    ...
    def _check_compliance(
        ...
        has_secrets = any(
            v.type == VulnerabilityType.HARDCODED_SECRET for v in vulnerabilities
        )
