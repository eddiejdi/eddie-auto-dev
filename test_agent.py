...
try:
    response = requests.post("http://localhost:11434/v1/chat/completions", 
        ...
        json={
            ...
            "messages": [
                {"role": "system", "content": "Retorne apenas JSON valido no formato: {\"action\": \"list_issues\", \"params\": {\"owner\": \"X\", \"repo\": \"Y\"}, \"confidence\": 1.0}"},
...
try:
    r = requests.get("https://api.github.com/repos/microsoft/vscode/issues?per_page=1", timeout=10)
