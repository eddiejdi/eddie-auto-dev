...
def test_classifier():
    ...
    assert (
        classified.is_spam or classified.is_promotional
    ), "Deveria ser classificado como spam/promo"
    ...
    assert (
        classified.is_important or classified.is_personal
    ), "Deveria ser classificado como importante"
