...
ltfsck  10600 root    4u   CHR  21,1      0t0  427 /dev/sg1
python3  858 root    5u   CHR  9,0       0t0  428 /dev/nst1
"""
...
def test_run_exclusive_operation_blocks_on_unexpected_holder(monkeypatch) -> None:
    ...
    response = ltfs_recovery._run_exclusive_operation("deep-recovery", ["ltfsck", "--deep-recovery", "/dev/sg1"])
