#!/usr/bin/env python3
"""Cria ou atualiza o aplicativo do relatorio da Conube no Authentik."""
...
APP_NAME = os.getenv("CONUBE_REPORT_APP_NAME", "Conube Report").strip() or "Conube Report"
APP_SLUG = os.getenv("CONUBE_REPORT_APP_SLUG", "conube-report").strip() or "conube-report"
APP_LAUNCH_URL = os.getenv(
    "CONUBE_REPORT_APP_URL",
    "https://auth.rpa4all.com/conube-report.html",
).strip()
APP_ICON_URL = os.getenv(
    "CONUBE_REPORT_APP_ICON_URL",
    "https://auth.rpa4all.com/conube-report-icon.svg",
).strip()
APP_DESCRIPTION = os.getenv(
    "CONUBE_REPORT_APP_DESCRIPTION",
    "Relatorio operacional da Conube com pendencias fiscais, certificado e acoes consolidadas.",
).strip()
APP_PUBLISHER = os.getenv("CONUBE_REPORT_APP_PUBLISHER", "RPA4ALL").strip()
