                    ...
                    if '"type":"redirect"' in line or '"type": "redirect"' in line:
                        ...
                        try:
                            ...
                            if start != -1 and end != -1 and end > start:
                                ...
                                if isinstance(obj, dict) and obj.get('type') == 'redirect':
                                    return True, 'redirect', json.dumps(obj, ensure_ascii=False)
                        except Exception:
...
def main(poll=30, timeout=3600):
    ...
    while True:
        ...
        if found and kind == 'redirect':
            ...
            publish_to_diretor('pending', 'Login page / redirect not yet detected', (payload or '')[:500])
