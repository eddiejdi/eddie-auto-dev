...
def main() -> int:
    ...
    parser.add_argument("--high-watermark-percent", type=int, default=85, help="Watermark alto staging (pct)")
    parser.add_argument("--low-watermark-percent", type=int, default=70, help="Watermark baixo staging (pct)")
