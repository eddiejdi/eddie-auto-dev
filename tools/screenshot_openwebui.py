...
async def capture(url: str = "http://127.0.0.1:3000/", out: str = "/tmp/openwebui_screenshot.png"):
...
def main():
    ...
    parser.add_argument('--url', default=os.environ.get('OPENWEBUI_URL', 'http://127.0.0.1:3000/'))
