...
print("   • Relatório de auditoria: tools/audit_agents_report.json")
...
print("\n🎯 PRÓXIMOS PASSOS:")
print("   1. Revisar documentação em docs/agents/")
print("   2. Complementar descrições e funcionalidades")
print("   3. Adicionar exemplos de uso e configuração")
if total_secrets > 0:
    print("   4. IMPORTANTE: Remover secrets do código-fonte")
    print("   5. Armazenar credenciais no Secrets Agent")
    print("   6. Usar variáveis de ambiente ou secrets management")
