...
content_parts.append(paragraph("Substituir o Vaultwarden auto-hospedado por um mecanismo simples e auditable baseado em GPG/SOPS para armazenar chaves de operação críticas."))

content_parts.append(heading(2, "Ações executadas"))
content_parts.append(bullet_list([
...
content_parts.append(paragraph('Diagrama disponível em: ' + link('../diagrams/migration_vault_to_simple_vault.drawio', 'migration_vault_to_simple_vault.drawio')))

content_parts.append(heading(2, "Passos Operacionais para Recuperação"))
content_parts.append(numbered_list([
