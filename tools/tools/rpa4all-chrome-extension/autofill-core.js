(function (root) {
  ...
  function setNativeValue(field, value) {
    ...
    try {
      const desc = Object.getOwnPropertyDescriptor(field, 'value') || Object.getOwnPropertyDescriptor(Object.getPrototypeOf(field), 'value');
      if (desc && typeof desc.set === 'function') {
        desc.set.call(field, valueStr);
      } else {
        field.value = valueStr;
      }
      return true;
    } catch (e) {
      try { field.value = valueStr; return true; } catch (e2) { return false; }
    }
  }
  ...
  function setFieldValue(field, rawValue) {
    ...
    if (field.tagName === 'SELECT') {
      ...
      if (exact) {
        setNativeValue(field, exact.value);
        return true;
      }
      ...
      if (partial) {
        setNativeValue(field, partial.value);
        return true;
      }
      ...
      if (numberInTarget) {
        ...
        if (byNumber) {
          setNativeValue(field, byNumber.value);
          return true;
        }
      }
