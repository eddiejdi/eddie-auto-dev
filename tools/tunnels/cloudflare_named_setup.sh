...
echo "Next steps (on your machine):"
 echo " - Copy the credentials file and config to the homelab (use ${HOMELAB_HOST}):"
 echo "   scp $CREDS_FILE user@${HOMELAB_HOST}:/tmp/"
 echo "   scp $CFG_YML user@${HOMELAB_HOST}:/tmp/"
